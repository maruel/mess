...
var botFiles = []string{
	...
	"third_party/urllib3/contrib/_appengine_environ.py",
	...
	"third_party/urllib3/contrib/appengine.py",
	"third_party/urllib3/contrib/ntlmpool.py",
	...
	"third_party/urllib3/packages/__init__.py",
	"third_party/urllib3/packages/backports/__init__.py",
	"third_party/urllib3/packages/backports/makefile.py",
	"third_party/urllib3/packages/six.py",
	"third_party/urllib3/packages/ssl_match_hostname/__init__.py",
	"third_party/urllib3/packages/ssl_match_hostname/_implementation.py",
	"third_party/urllib3/poolmanager.py",
	"third_party/urllib3/request.py",
	"third_party/urllib3/response.py",
	"third_party/urllib3/util/__init__.py",
	"third_party/urllib3/util/connection.py",
	"third_party/urllib3/util/queue.py",
...
func getBotZIP() ([]byte, error) {
	...
	for _, f := range botFiles {
		raw, err := os.ReadFile(filepath.Join("..", "third_party", "swarming_bot", f))
		if err != nil {
			return nil, err
		}
		f, err := w.Create(f)
...
const tmpl = `// Code generated by "genbot.go"; DO NOT EDIT.
...
func main() {
	...
	b := bytes.NewBufferString("// Code generated by \"genbot.go\"; DO NOT EDIT.\n\npackage internal\n\nvar botZipRaw = [...]byte{")
	for i, c := range raw {
		if i%32 == 0 {
			b.WriteByte('\n')
			b.WriteByte('\t')
	...
	b.WriteByte('}')
	b.WriteByte('\n')
	err = os.WriteFile("botzip.go", b.Bytes(), 0o644)
	if err != nil {
		log.Fatal(err)
	}
}
